            ...
            ? feed.map((item, idx) => {
                return (
                  <a
                    ...
                    rel="noreferrer"
                    key={idx}
                    className="z-50 w-full cursor-pointer rounded-sm border border-[var(--bg-secondary)] px-2 pt-0.5 pb-2 before:absolute before:top-4 before:-left-5 before:size-2 before:rounded-full before:bg-[var(--color-primary-light)] hover:[&>h3]:text-[var(--color-primary-dark)] focus:[&>h3]:text-[var(--color-primary-dark)]"
                  >
